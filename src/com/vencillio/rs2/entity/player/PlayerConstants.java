...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "Daniel", "", "", "", "" };
	 ...
	 * Home teleport
	 */
	public static Location HOME = new Location(2847, 10219, 0);
	 ...
	 * Jailed area
	 */
	public static Location JAILED_AREA = new Location(2140, 3913, 2);
	
	/**
	 * Staff area
	 */
	public static Location STAFF_AREA = new Location(2142, 3904, 2);
	
	/**
	 * Member zone
	 */
	public static Location MEMEBER_AREA = new Location(2099, 3914, 0);
	...
	public static boolean isStaff(Player player) {
		if (player.getRights() == 1 || player.getRights() == 2 || player.getRights() == 3 || player.getRights() == 4 || player.getRights() == 9) {
			return true;
		}
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("Daniel") || p.getUsername().equalsIgnoreCase("Exhumedsoul");
	}
	...
	public static boolean isDeveloper(Player p) {
		return p.getAttributes().get("developerkey") != null || p.getUsername().equalsIgnoreCase("Nate") || p.getUsername().equalsIgnoreCase("") || p.getUsername().equalsIgnoreCase("") || p.getUsername().equalsIgnoreCase("");
	}
