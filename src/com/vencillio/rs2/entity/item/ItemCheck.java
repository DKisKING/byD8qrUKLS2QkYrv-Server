...
public class ItemCheck {
	...
	public static boolean wearingFullEliteVoidMagic(Player player) {
	 int[] slots = { 0, 4, 7, 9 };
	 int[] ids = { 11663, 13072, 13073, 8842 };
	 ...
	 public static boolean wearingFullEliteVoidMelee(Player player) {
	 int[] slots = { 0, 4, 7, 9 };
	 int[] ids = { 11665, 13072, 13073, 8842 };
	 Item[] equip = player.getEquipment().getItems();
	 ...
	 public static boolean wearingFullEliteVoidRanged(Player player) {
	 int[] slots = { 0, 4, 7, 9 };
	 int[] ids = { 11664, 13072, 13073, 8842 };
	 Item[] equip = player.getEquipment().getItems();
