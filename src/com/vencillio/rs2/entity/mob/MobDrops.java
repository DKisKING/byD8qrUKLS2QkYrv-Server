...
public class MobDrops {
	...
	public static void dropItems(Entity entity, Mob mob) {
		...
		case 3578:
			player.pvmPoints ++;
			player.setlunarPoints(player.getlunarPoints() + 500);
			player.send(new SendBanner("You now have " + player.getlunarPoints() + " Tyras Points.", 0));
			player.getProperties().addProperty(mob, 1);
			break;
		...
		case 2643:
			player.bossPoints += 5;
			player.pvmPoints += 10;
			player.send(new SendBanner("You now have " + player.getbossPoints() + " Boss points & " + player.getpvmPoints() + " Pvm points.", 0));
			player.getProperties().addProperty(mob, 1);
			break;
		...
		case 2954:
			...
			player.send(new SendBanner("You now have " + player.getArenaPoints() + " Mage Arena points.", 0));
			player.pvmPoints ++;
