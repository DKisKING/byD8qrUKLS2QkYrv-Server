...
public final class MobConstants {
	 ...
	 */
	public static final int[] LOGGED_NPCS = new int[] { 84, 3358, 1540, 5862, 6119, 3578, 4315, 6618, 6619, 6610, 6612, 6615, 5779, 6609, 2054, 494, 2265, 2266, 2267, 319, 6342, 8, 415, 4005, 2042, 239, 2215, 3162, 2205, 3129, 3127 };
	 ...
	 */
	private static String[] NON_AGGRESSIVE_NPCS = { "cerberus", "plague", "zezima", "zulrah", "saradomin wizard", "zamorak wizard", "man", "woman", "gnome", "dwarf", "cow", "guard", "goblin", "banker", "tzhaar-xil", "tzhaar-ket" };
	...
	//cerb ghosts
	public static boolean isGhosts(Mob m) {
	  int id = m.getId();
	  return (id == 5867) || (id == 5868) || (id == 5869);
	 }
