...
public class QuestTab extends InterfaceHandler {
	...
	private final String[] text = {
			...
			"@or2@Online Staff: @whi@" + World.getStaff(),
			...
			"@or2@Version: @whi@" + VencillioConstants.VERSION,
			"",
			...
			"@or2@Money Donated: @whi@$" + Utility.format(player.getMoneySpent()),
			"@or2@Tyras Credits: @whi@" + Utility.format(player.getCredits()),			
			"@or2@Points Log [</col>View@or2@]",
			"",
			"",
	};
