...
public class PlayerProfiler {
	...
	public static void displayProfile(Player player, Player viewing) {
		...
		player.send(new SendString("Player Profile", 51802));
		...
		player.send(new SendString("</col>PVM Points: @whi@" + viewing.getpvmPoints(), 51890));
		player.send(new SendString("</col>Boss Points: @whi@" + viewing.getbossPoints(), 51891));
		player.send(new SendString("</col>Slayer Points: @whi@" + viewing.getSlayerPoints(), 51892));
		player.send(new SendString("</col>PC Points: @whi@" + viewing.getPestPoints(), 51893));
	...
	public static void myProfile(Player player) {
		...
		player.send(new SendString("</col>PVM Points: @whi@" + player.getpvmPoints(), 51891));
		player.send(new SendString("</col>Boss Points: @whi@" + player.getbossPoints(), 51892));
		player.send(new SendString("</col>Slayer Points: @whi@" + player.getSlayerPoints(), 51693));
		player.send(new SendString("</col>PC Points: @whi@" + player.getPestPoints(), 51694));
