...
public class HomeStalls extends Task {
	...
	if (random == 1) {
		...
		player.getUpdateFlags().sendAnimation(new Animation(3103));
		player.getClient().queueOutgoingPacket(new SendMessage("Someone trips you as you try to steal from the stall. "));
	...
	public final static String FORCED_CHAT[] = {"Ow!"};
