...
public final class SpellBookTeleporting {
	...
	enum TeleportationData {
		...
		HOME_TELEPORT(2847, 10219, 75010, 1, new int[] { AIR_RUNE, 3, FIRE_RUNE, 1, LAW_RUNE, 1 }),
		...
		HOME_TELEPORT_ANCIENT(2847, 10219, 84237, 1, new int[] { AIR_RUNE, 3, FIRE_RUNE, 1, LAW_RUNE, 1 }),
