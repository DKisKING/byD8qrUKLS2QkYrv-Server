...
public class CookingTask extends Task {
	...
	public static boolean isCookableObject(GameObject object) {
		...
		return name.equals("range") || name.equals("fire") || object.equals(5249) || name.contains("oven") || name.contains("stove") || name.contains("cooking range") || name.contains("fireplace");
	}
