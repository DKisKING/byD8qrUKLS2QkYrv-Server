...
import com.vencillio.rs2.content.skill.woodcutting.StumpTask;
...
import com.vencillio.rs2.content.skill.mining.deadoretask;
...
public class Mining {
	...
	public static enum Ore {
		COPPER("Copper ore", new int[] { 7487, 7454 }, 1, 17.5, new int[] { 436 }, 10081, 6, 4),
		TIN("Tin ore", new int[] { 7457, 7490 }, 1, 17.5, new int[] { 438 }, 10081, 6, 4),
		IRON("Iron ore", new int[] { 7455 }, 15, 35, new int[] { 440 }, 10081, 12, 7),
		SILVER_ORE("Silver ore", new int[] { 13716, 13717 }, 20, 40, new int[] { 442 }, 10081, 15, 10),
		COAL_ORE("Coal ore", new int[] { 7456 }, 30, 50, new int[] { 453 }, 10081, 12, 10),
		GOLD_ORE("Gold ore", new int[] { 7491, 7458 }, 40, 65, new int[] { 444 }, 10081, 15, 10),
		MITHRIL_ORE("Mithril ore", new int[] { 7459 }, 55, 80, new int[] { 447 }, 10081, 15, 13),
		ADAMANT_ORE("Adamant ore", new int[] { 7460 }, 70, 95, new int[] { 449 }, 10081, 15, 16),
		RUNITE_ORE("Runite ore", new int[] { 7461 }, 85, 125, new int[] { 451 }, 10081, 15, 18),
