...
public class Skills {
	...
	public static void declare() {
		EXPERIENCE_RATES[ATTACK] = 20; //done
		EXPERIENCE_RATES[DEFENCE] = 20; //done
		EXPERIENCE_RATES[STRENGTH] = 20; //done
		EXPERIENCE_RATES[HITPOINTS] = 20; //done
		EXPERIENCE_RATES[RANGED] = 18; //done
		EXPERIENCE_RATES[PRAYER] = 45; //done
		EXPERIENCE_RATES[MAGIC] = 13; //done
		EXPERIENCE_RATES[COOKING] = 21; //done
		EXPERIENCE_RATES[WOODCUTTING] = 21; //done
		EXPERIENCE_RATES[FLETCHING] = 25; //done
		EXPERIENCE_RATES[FISHING] = 20; //done
		EXPERIENCE_RATES[FIREMAKING] = 20; //done
		EXPERIENCE_RATES[CRAFTING] = 25; //done
		EXPERIENCE_RATES[SMITHING] = 22; //done
		EXPERIENCE_RATES[MINING] = 23; //done
		EXPERIENCE_RATES[HERBLORE] = 25; //done
		EXPERIENCE_RATES[AGILITY] = 60; //done
		EXPERIENCE_RATES[THIEVING] = 25; //done
		EXPERIENCE_RATES[SLAYER] = 25; //done
		EXPERIENCE_RATES[HUNTER] = 26; //done
		EXPERIENCE_RATES[FARMING] = 35; //done
		EXPERIENCE_RATES[RUNECRAFTING] = 45; //done
		EXPERIENCE_RATES[DUNGEONEERING] = 40; //done
		EXPERIENCE_RATES[SUMMONING] = 27; //done
	}
