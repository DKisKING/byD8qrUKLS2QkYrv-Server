...
public class Skill {
	...
	private static final int MAX_TOTAL = 2079;
	private static final int SKILLER_TOTAL = 1402;
	
	/**
	 * Check for if player is maxed or not
	 */
	
	public boolean isMaxed() {
		if (getTotalLevel() >= Skill.MAX_TOTAL) {
			return true;
		}
		return false;
	}
	
	public boolean isskillerMaxed() {
	if (getTotalLevel() > Skill.SKILLER_TOTAL) {
		return true;
	}
	return false;
}
	 ...
	 * Melee experience
	 */
	private int meleeExp = 7;
	
	/**
	 * Range experience
	 */
	private int rangeExp = 10;
	
	/**
	 * Magic experience
	 */
	private int magicExp = 8;
