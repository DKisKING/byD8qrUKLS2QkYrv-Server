...
public class PlayerCombatInterface implements CombatInterface {
	...
	public void hit(Hit hit) {
		...
		if (player.getEquipment().isWearingItem(12931, 0)) { //Serp Helm 16.7% chance to poison upon getting hit
			if (Utility.getRandom(5) == 0) {
				hit.getAttacker().hit(new Hit(hit.getAttacker(), 6, Hit.HitTypes.POISON));
			}
		}
