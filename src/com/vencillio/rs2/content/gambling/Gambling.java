...
public class Gambling {
    ...
    private static final int MAXIMUM_AMOUNT = 2147483647;
    ...
    public static boolean canPlay(Player player, int amount) {
    	...
    	//	DialogueManager.sendNpcChat(player, 1011, Emotion.DEFAULT, "Sorry, but Dez has forbidden you from gambling.");
    	//	return false;
    	//}
