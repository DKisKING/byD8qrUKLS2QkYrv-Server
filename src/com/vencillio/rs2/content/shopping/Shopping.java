				...
				if (shop.get(i) != null) {
					...
					if (shop != null && shop.getCurrencyName() != null) {
						...
						case "Farming points":
							currency = 24;
							break;
						case "Woodcutting points":
							currency = 23;
							break;
						case "Firemaking points":
							currency = 22;
							break;
						case "Cooking points":
							currency = 21;
						...
						case "Fishing points":
							currency = 20;
							break;
						case "Smithing points":
							currency = 19;
							break;
						case "Fletching points":
							currency = 18;
							break;
						case "Crafting points":
							currency = 17;
							break;
						case "Thieving points":
							currency = 16;
							break;
						case "Herblore points":
							currency = 15;
							break;
						case "Hunter points":
							currency = 14;
							break;
						case "Runecrafting points":
							currency = 13;
							break;
						case "Prayer points":
							currency = 12;
