 ...
 */
public TriviaShop() {
	super(SHOP_ID, new Item[] { new Item(12641), new Item(2677), new Item(2801), new Item(989), new Item(10115), new Item(10117), new Item(13283), new Item(13284), new Item(13285), new Item(13286), new Item(13287), new Item(13192) }, 
