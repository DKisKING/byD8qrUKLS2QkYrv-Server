...
public class CrystalChest {
	...
	public static final Item[] UNCOMMON_CHEST_REWARDS = { new Item(), new Item(12504), new Item(12502), new Item(12500), new Item(12498), 
			...
			new Item(ItemNames.DRAGON_LONGSWORD), new Item(4675), new Item(12193), new Item(12195), new Item(12197), new Item(12199), new Item(12203), new Item(12490), new Item(12492), new Item(12494), new Item(12496), new Item(12608), new Item(12610), new Item(12612), new Item(10384), new Item(10386), new Item(10388), new Item(10390), new Item(10368), new Item(10370), new Item(10372), new Item(10374), new Item(10376), new Item(10378), new Item(10380), new Item(10382), new Item(10444), new Item(10450), new Item(ItemNames.TZHAARKETEM), new Item(4745), new Item(4747), new Item(4749), new Item(4751), new Item(ItemNames.TZHAARKETOM),  new Item(4753), new Item(4755), new Item(4757), new Item(4759), };

	public static final Item[] RARE_CHEST_REWARDS = { , };
