...
public class TeleportHandler {
	...
	public enum TeleportationData {
		...
		/** Training */
		TRAINING_ZONE(238123, 0, "Beginners", "Ckeys = Common", 2500, new Location(1815, 3856, 0), false, false),
		ROCK_CRABS(238124, 0, "None", "None", 0, new Location(2674, 3710, 0), false, false),
		NIEVES_DUNGEON(238125, 0, "Cave Krakens", "80% Done!", 0, new Location(2441, 9808, 0), false, false),
		HILL_GIANTS(238126, 0, "None", "None", 0, new Location(3117, 9856, 0), false, false),
		YAKS(238127, 0, "None", "None", 0, new Location(2321, 3804, 0), false, false),
		BRIMHAVEN_DUNG(238128, 0, "None", "None", 0, new Location(2709, 9564, 0), false, false),
		TAVERLY_DUNG(238129, 0, "None", "None", 0, new Location(2884, 9798, 0), false, false),
		SLAYER_TOWER(238130, 0, "None", "None", 0, new Location(3428, 3538, 0), false, false),
		LAVA_DRAGONS(238131, 0, "40+ Wild!", "None", 0, new Location(3202, 3860, 0), false, false),
		MITHRIL_DRAGONS(238132, 0, "None", "None", 0, new Location(1747, 5324, 0), false, false),

		/** Skilling */
		SKILLER_VILLAGE(242099, 0, "Skilling Zone", "Train Here!", 0, new Location(3001, 3383, 0), false, false), //done
		WILD_RESOURCE(242100, 0, "Dangerous Area!", "54 Wild!", 0, new Location(3184, 3947, 0), false, false), //done
	//	CRAFTING(242101, 0, "None", "None", 0, new Location(2933, 3290, 0), false, false), //done
		AGILITY(242101, 0, "Do you Parkour?", "Well start now!", 0, new Location(2480, 3437, 0), false, true), //done
	//	MINING(242103, 0, "None", "None", 0, new Location(2933, 3290, 0), false, false), //done
	//	SMITHING(242104, 0, "None", "None", 0, new Location(3684, 3479, 0), false, false),
	//	FISHING(242105, 0, "None", "None", 0, new Location(2615, 3847, 0), false, false), //done
	//	WOODCUTTING(242106, 0, "None", "None", 0, new Location(2722, 3473, 0), false, false),
		FARMING(242102, 0, "None", "None", 0, new Location(2806, 3463, 0), false, true), //done
		//HUNTER(242108, 0, "", "None", 0, new Location(2368, 3614, 0), false, false), //done
		...
		/** Player Vs Monster */
		KING_BLACK_DRAGON(250051, 10000, "High combat", "40+ Wild", 276, new Location(2997, 3849, 0), false, false),
		SEA_TROLL_QUEEN(250052, 15000, "High combat", "Multi", 170, new Location(2336, 3692, 0), false, false),
		BARRELCHEST(250053, 12500, "High combat", "Instanced", 190, new Location(3238, 9364, 0), true, true),
		CORPOREAL_BEAST(250054, 15000, "High combat", "Team Based", 785, new Location(2948, 4385, 2), false, false),
		DAGGANNOTH_KINGS(250055, 8000, "High combat", "", 303, new Location(1909, 4367, 0), false, false),
		GOD_WARS(250056, 25000, "High combat", "Team Based", 0,  new Location(2882, 5308, 2), false, false),
		ZULRAH(250057, 30000, "High combat", "Hard", 725, new Location(2268, 3070, 0), true, true),
		KRAKEN(250058, 25000, "High combat", "", 291, new Location(3696, 5807, 0), true, true),
		GIANT_MOLE(250059, 5000, "High combat", "", 230, new Location(1760, 5163, 0), false, false),
		CHAOS_ELEMENTAL(250060, 12000, "High combat", "50+ Wild", 305, new Location(3284, 3913, 0), false, false),
		CALLISTO(250061, 15000, "High combat", "40+ Wild", 470, new Location(3283, 3853, 0), false, false),
		SCORPIA(250062, 15000, "High combat", "50+ Wild", 225, new Location(3233, 3943, 0), false, false),
		VETION(250063, 15000, "High combat", "30+ Wild", 454, new Location(3210, 3780, 0), false, false),
		VENENATIS(250064, 15000, "Low combat", "20+ Wild", 464, new Location(3351, 3728, 0), false, false),
		CHAOS_FANATIC(250065, 15000, "High combat", "40+ Wild", 202, new Location(2981, 3837, 0), false, false),
		CRAZY_ARCHAEOLOGIST(250066, 5000, "Low combat", "20+ Wild", 204, new Location(2975, 3715, 0), false, false),
		KALPHITE_QUEEN(250067, 10000, "None", "None", 333, new Location(3481, 9507, 0), false, false),
		WILDERNESS_BOSSES(250068, 0, "10+ Wild", "Drops Vesta!", 333, new Location(3070, 3607, 0), false, false),
	...
	public static boolean specialCase(Player player, int buttonId) {
		...
		case 254033://Clan Wars
			player.send(new SendMessage("@dre@Walk west to enter the Free for all arena!"));
			return true;
		...
		case 250053://Barrelchest
			TaskQueue.queue(new Task(player, 4, false, Task.StackType.STACK, Task.BreakType.NEVER, TaskIdentifier.CURRENT_ACTION) {
				@Override
				public void execute() {
					new Mob(player, 6342, true, false, false, new Location(3250, 9364, player.getIndex() << 2));
					stop();
				}
				@Override
				public void onStop() {
		...
		case 238123://training zone
			player.send(new SendMessage("@red@TIP</col> Ghosts commonly drop Crystal keys! @red@TIP</col>"));
			break;
			
		case 238125://nieves
			player.send(new SendMessage("@red@Beware:</col> Cave krakens lair to the east!!"));
			break;
		...
		//case 238125://Membership
		//	if (PlayerConstants.isPlayer(player)) {
		//		DialogueManager.sendNpcChat(player, 5525, Emotion.DEFAULT, "You need to be a <img=4>@red@member </col>to visit this area!");
		//		return false;
		//	}
		//	return true;
		...
		case 240112://Staffzone
			if (!PlayerConstants.isStaff(player)) {
				DialogueManager.sendStatement(player, "you have to be a <img=1>Player Moderator to teleport here.");
				return false;
			}
			return true;
		}
