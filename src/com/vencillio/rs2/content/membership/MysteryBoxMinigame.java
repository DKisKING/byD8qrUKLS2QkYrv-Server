...
public class MysteryBoxMinigame {
	 ...
	 */
	private final static int EXPENSIVE_AMOUNT = 350_000;
	...
	public static Chance<Item> available = new Chance<Item>(Arrays.asList(
			...
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(392, 100)), //Manta ray
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11937, 100)), //Dark crab
			...
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(7462, 1)), //Barrows Gloves
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(19484, 100)), //Dragon Javelin
			...
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(995, 20000000)), //20m GP
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(ItemNames.DRAGON_CHAINBODY,1)), //Dragon Chainbody
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(19481,1)), //Heavy Ballista
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(ItemNames.ARMADYL_GODSWORD, 1)) //Armadyl Godsword
