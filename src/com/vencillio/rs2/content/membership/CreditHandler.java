...
public enum CreditHandler {
	...
	SPECIAL_ATTACK(205052, 2, new Handle() {
		@Override
		public void handle(Player player) {
			...
			spent(player, 2);
			player.send(new SendMessage("You have restored your Special Attack!"));
		}
	}),
	RESTORE_PRAYER(205053, 2, new Handle() {
		@Override
		public void handle(Player player) {
			...
			spent(player, 2);
			player.send(new SendMessage("You have restored your Prayer Points!"));
		}
	}),
	...
	public static boolean allowed(Player player, CreditPurchase credit, int amount) {
		...
		if (player.getCredits() < amount) {
			...
			player.send(new SendMessage("Please visit @red@https://www.projectreality.co/donate </col>to purchase more credits!"));
			return false;
		}
