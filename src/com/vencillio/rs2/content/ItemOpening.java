...
public enum ItemOpening {
	...
	DRAGON_BONE_PACK(12792, new Item(537, 50)),
	DRAGON_DART_PACK(12641, new Item(11230, 50)), 
	
	/* Barrows sets */
	GUTHANS_ARMOUR_SET(12873, new Item(4724), new Item(4726), new Item(4728), new Item(4730)),
	AHRIMS_ARMOUR_SET(12881, new Item(4708), new Item(4710), new Item(4712), new Item(4714)),
	VERACS_ARMOUR_SET(12875, new Item(4724), new Item(4726), new Item(4728), new Item(4730)),
	DHAROKS_ARMOUR_SET(12877, new Item(4716), new Item(4718), new Item(4720), new Item(4722)),
	TORAGS_ARMOUR_SET(12879, new Item(4745), new Item(4747), new Item(4749), new Item(4751)),
	KARILS_ARMOUR_SET(12883, new Item(4732), new Item(4734), new Item(4736), new Item(4738)),
	...
	/* H'ween Mask Set */
	HALLOWEEN_SET(13175, new Item(1053, 1), new Item(1055, 1), new Item(1057, 1));
