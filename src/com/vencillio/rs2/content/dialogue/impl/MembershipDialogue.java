...
public class MembershipDialogue extends Dialogue {
	...
	public boolean clickButton(int id) {
		...
		case DialogueConstants.OPTIONS_5_2:
			player.send(new SendString("http://forums.projectreality.co", 12000));
			break;
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, 5525, Emotion.DEFAULT, "Hello adventurer. How may I help you?");
			next ++;
			break;
		case 1:
			...
			break;
		case 2:
			DialogueManager.sendNpcChat(player, 5525, Emotion.DEFAULT, "Tyras credits can be purchased on our online store.", "They can be used for buying items from my store ", "and many other features in game.", "Including purchasing credits in the credits tab.");
			setNext(1);
			break;
		case 3:
			DialogueManager.sendNpcChat(player, 5525, Emotion.DEFAULT, "Alright, let me check out the database...");
			next ++;
			break;
		case 4:
